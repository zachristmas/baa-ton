...
export type SpecAction = { kind: "build" | "review" | "integrate"; itemId: string; attempt: number; findings?: string };
export function advanceSpec(input: {
  ...
  state: SpecState;
  actions: SpecAction[];
  rootAsks: Array<{ itemId: string; reason: string; kind?: "push"; items?: string[]; sha?: string }>;
