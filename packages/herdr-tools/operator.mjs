...
export function registerOperatorAgent(store, { name, paneId, workspaceId, agentKind, at = nowIso() }) {
  ...
  store.agents[name] = { paneId, ...(workspaceId ? { workspaceId } : {}), ...(agentKind ? { agentKind } : {}), registeredAt: at };
