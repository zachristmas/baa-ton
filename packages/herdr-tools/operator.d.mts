...
export type OperatorStore = { version: number; agents: Record<string, { paneId: string; workspaceId?: string; agentKind?: string; registeredAt: string }>; messages: OperatorMessage[] };
...
export function registerOperatorAgent(store: OperatorStore, input: { name: string; paneId?: string; workspaceId?: string; agentKind?: string; at?: string }): OperatorStore["agents"][string];
